...
in {
      ...
      # set the Hyprland and XDPH packages to null
      # to use the ones from NixOS module
      # package = null; # only in unstable (stable 24.11)
      # portalPackage = null; # only in unstable (stable 24.11)
      settings = {
